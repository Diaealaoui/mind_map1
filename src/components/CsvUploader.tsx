    ...
    try {
      ...
      const response = await fetch('https://hjaqnjjptipnxeonojip.supabase.co/functions/v1/77ef7376-0f30-4506-86a4-1fa6f75989ac', {
        ...
        headers: { 
          ...
          'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImhqYXFuampwdGlwbnhlb25vamlwIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDk1OTczNzMsImV4cCI6MjA2NTE3MzM3M30.VlY2gSvHammlUkErPoSaOzF9wExU3gGjRS_8_jIOlGw'
        },
        body: JSON.stringify({ 
          action: 'create_table',
          tableName,
          ...
          <CardContent className="space-y-6">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-2">
                Upload a CSV file to automatically create a database table and populate it with data.
              </p>
            </div>
            ...
            {result && (
              <div className={`flex items-start gap-3 p-4 rounded-lg ${
                ...
                <div>
                  ...
                  {result.tableName && (
                    <p className="text-xs mt-1">Table name: {result.tableName}</p>
                  )}
                </div>
              </div>
            )}
